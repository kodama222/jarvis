...
def load_data():
    ...
    ape_insiders = ape_holders.drop(columns=['BAYC Holders', 'Jane Goodall L. Foundation'])
    ape_non_insiders = ape_holders[['BAYC Holders', 'Jane Goodall L. Foundation']]
    
    ape2 = pd.concat([ape_insiders, ape_non_insiders], keys=['Insiders', 'Non Insiders'], axis=1)
